...
public class DataApiUtility {
	...
	// private static final SimpleDateFormat formatYearMonth = new
	// SimpleDateFormat("yyyy-MM");
	// private static final SimpleDateFormat formatFullDate = new
	// SimpleDateFormat("yyyy-MM-dd");
	// private static final SimpleDateFormat formatFullDateTime = new
	...
	// private static final SimpleDateFormat formatHHmm = new
	...
	public static String getNextDate(String curDate) {
		...
		try {
			...
			// System.out.println("curDate = " + curDate + ", new Date = " +
	...
	public static long ipToLong(String ipAddress) {
		...
		// result += (Integer.parseInt(ipAddressInArray[i]) % 256 * Math.pow(256,
		// power));
		return result;
	}
