...
public class JwtService {
    ...
    // }
    public String generateToken(Employee emp, AuthScope scope) {
        Map<String, Object> claims = new HashMap<>();
        claims.put(KEY_SCOPE, scope.value);
        claims.put(KEY_NAME, emp.getName());
        claims.put(KEY_EMAIL, emp.getEmail());
        return createToken(claims, String.valueOf(emp.getEmpId()));
    }
    ...
    public Boolean validateTokenId(String token, Employee emp) {
